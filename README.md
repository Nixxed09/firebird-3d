...
Click the screen once to grab the mouse and start.
...
| `Tab` | Automap |
| `M` | Music on/off |
| Arrow keys | Move and turn (no-mouse option) |
| `Enter` | Start / next level / retry |
...
node tests/headless.test.js   # the real engine, playing scripted scenarios
